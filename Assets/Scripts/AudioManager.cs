...
public class AudioManager : MonoBehaviour
{
    ...
    public static float MainVolume
    {
        get
        {
            if (mainVolume == -1)
            {
                mainVolume = PlayerPrefs.GetFloat("VOICE_VOLUME", DefaultVoiceVolume);
            }
    ...
    public static void Save()
    {
        ...
        PlayerPrefs.SetFloat("VOICE_VOLUME", MainVolume);
        PlayerPrefs.Save();
    }
    ...
    {
        m_VoiceSource.volume = MainVolume * DefaultVoiceVolume * volumeScale;
    ...
    private void Start()
    {
        //Debug.Log("volume = " + GlobalConfig.Instance.userData.musicAudioVolume);
        //ChangeMusicVolume(GlobalConfig.Instance.userData.musicAudioVolume);
        //ChangeMusicVolume(GlobalConfig.Instance.userData.vfxAudioVolume);

        //PlayBgm("Background", GlobalConfig.Instance.userData.musicAudioVolume);
    }
    ...
    {
        //PlaySfx("NormalButton", GlobalConfig.Instance.userData.vfxAudioVolume);
    }

    public void PlayVictory()
    {
        //PlaySfx("victory", GlobalConfig.Instance.userData.musicAudioVolume);
    }

    public void PlayLose()
    {
        //PlaySfx("lose", GlobalConfig.Instance.userData.musicAudioVolume);
    }

    public void PlayPrepare()
    {
        //PlayBgm("Khoi_dong_van", GlobalConfig.Instance.userData.musicAudioVolume);
    }

    public void PlayCombat()
    {
        //PlayBgm("combat", GlobalConfig.Instance.userData.musicAudioVolume);
    }
